...
{
    public static class TestLaunchViewObjects
    {
        public static LaunchView Test1()
        {
            var test1 = new LaunchView()
            {
                Id = new Guid("000ebc80-d782-4dee-8606-1199d9074039"),
                AtualizationDate = new DateTime(2023, 01, 02, 23, 23, 00),
                ImportedT = new DateTime(2023, 01, 02, 23, 23, 00),
                ...
                LaunchServiceProvider = new LaunchServiceProviderView()
                {
        ...
        public static LaunchView Test2()
        {
            var test2 = new LaunchView()
            {
        ...
        public static LaunchView Test3()
        {
            var test3 = new LaunchView()
            {
