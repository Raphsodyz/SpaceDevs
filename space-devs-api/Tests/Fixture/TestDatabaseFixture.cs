...
namespace Tests.Fixture
{
    ...
    {
        public readonly BaseApiContext Context;
        private readonly DbContextOptions<BaseApiContext> Options;
        public readonly ILaunchRepository Launch;

        public TestDatabaseFixture()
        {
            Options = new DbContextOptionsBuilder<BaseApiContext>()
                .UseInMemoryDatabase("futurespacecommanddbtest")
                .ConfigureWarnings(warn => warn.Ignore(InMemoryEventId.TransactionIgnoredWarning))
                .Options;
            Context = new BaseApiContext(Options);
