    ...
    public class FutureSpaceMapper : Profile
    {
        public FutureSpaceMapper()
        {
            ...
            CreateMap<LaunchBaseEntityAggregate, Launch>()
                ...
                .ForPath(entity => entity.Status.IdFromApi, dto => dto.MapFrom(src => src.StatusBaseEntity.IdFromApi))
                ...
                .ForPath(entity => entity.LaunchServiceProvider.IdFromApi, dto => dto.MapFrom(src => src.LaunchServiceProviderBaseEntity.IdFromApi))
                ...
                .ForPath(entity => entity.Rocket.IdFromApi, dto => dto.MapFrom(src => src.RocketBaseEntity.IdFromApi))
                ...
                .ForPath(entity => entity.Rocket.Configuration.IdFromApi, dto => dto.MapFrom(src => src.ConfigurationBaseEntity.IdFromApi))
                ...
                .ForPath(entity => entity.Mission.IdFromApi, dto => dto.MapFrom(src => src.MissionBaseEntity.IdFromApi))
                ...
                .ForPath(entity => entity.Mission.Orbit.IdFromApi, dto => dto.MapFrom(src => src.OrbitBaseEntity.IdFromApi))
                ...
                .ForPath(entity => entity.Pad.IdFromApi, dto => dto.MapFrom(src => src.PadBaseEntity.IdFromApi))
                ...
                .ForPath(entity => entity.Pad.Location.IdFromApi, dto => dto.MapFrom(src => src.LocationBaseEntity.IdFromApi))
